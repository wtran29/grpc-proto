...
import (
	...
	extResiliency "github.com/wtran29/grpc-proto/protogen/go/resiliency"
...
func RegisterResiliencyWithMetadataServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server extResiliency.ResiliencyWithMetadataServiceServer) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/unary"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterResiliencyWithMetadataServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client extResiliency.ResiliencyWithMetadataServiceClient) error {
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_UnaryResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/UnaryResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/unary"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ServerStreamingResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/server_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/ClientStreamingResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/client_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyWithMetadata_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/resiliency.ResiliencyWithMetadataService/BiDirectionalResiliencyWithMetadata", runtime.WithHTTPPathPattern("/api/resiliency/v1/bidirectional_streaming"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_ResiliencyWithMetadataService_UnaryResiliencyWithMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "resiliency", "v1", "unary"}, ""))

	pattern_ResiliencyWithMetadataService_ServerStreamingResiliencyWithMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "resiliency", "v1", "server_streaming"}, ""))

	pattern_ResiliencyWithMetadataService_ClientStreamingResiliencyWithMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "resiliency", "v1", "client_streaming"}, ""))

	pattern_ResiliencyWithMetadataService_BiDirectionalResiliencyWithMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "resiliency", "v1", "bidirectional_streaming"}, ""))
)
